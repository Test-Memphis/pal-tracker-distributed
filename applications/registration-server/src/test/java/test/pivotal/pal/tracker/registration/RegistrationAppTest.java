...
public class RegistrationAppTest {
    ...
    public void embedded() {
        ...
        assertThat(restTemplate.getForObject("http://localhost:8181/accounts?ownerId=1", String.class)).isEqualTo("[]");
        assertThat(restTemplate.getForObject("http://localhost:8181/projects?accountId=1", String.class)).isEqualTo("[]");
